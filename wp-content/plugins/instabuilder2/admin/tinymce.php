...
final class _IB_Tinymce {
	...
	public static function editor( $content, $editor_id, $settings = array() ) {
		...
		} else if ( self::$this_quicktags && self::$this_tinymce ) {
	...
	public static function editor_settings($editor_id, $set) {
		...
		if ( empty(self::$first_init) ) {
			add_action( 'ib2_print_footer_scripts', array( __CLASS__, 'editor_js' ), 50 );
			add_action( 'ib2_print_footer_scripts', array( __CLASS__, 'enqueue_scripts' ), 1 );
		}
	...
	public static function enqueue_scripts() {
		echo ib2_script_localize('wordCountL10n', array(
		...
		echo "<script type='text/javascript' src='" . admin_url('js/word-count.min.js') . "'></script>\n";

		if ( self::$has_tinymce )
			echo "<script type='text/javascript' src='" . admin_url('js/editor.min.js') . "'></script>\n";

		if ( self::$has_quicktags ) {
			echo ib2_script_localize('quicktagsL10n', array(
			...
			echo "<script type='text/javascript' src='" . includes_url('js/quicktags.min.js') . "'></script>\n";
			//wp_enqueue_style( 'buttons' );
		}

		if ( in_array('wplink', self::$plugins, true) || in_array('link', self::$qt_buttons, true) ) {
			echo ib2_script_localize('wpLinkL10n', array(
			...
			echo "<script type='text/javascript' src='" . includes_url('js/wplink.min.js') . "'></script>\n";
		}

		if ( in_array('wpfullscreen', self::$plugins, true) || in_array('fullscreen', self::$qt_buttons, true) )
			echo "<script type='text/javascript' src='" . admin_url('js/wp-fullscreen.min.js') . "'></script>\n";

		if ( self::$has_medialib ) {
			echo ib2_script_localize('thickboxL10n', array(
					'next' => __('Next &gt;'),
					'prev' => __('&lt; Prev'),
					'image' => __('Image'),
					'of' => __('of'),
			...
			echo "<script type='text/javascript' src='" . includes_url('js/thickbox.min.js') . "'></script>\n";
			echo "<script type='text/javascript' src='" . admin_url('js/media-upload.min.js') . "'></script>\n";
		}
