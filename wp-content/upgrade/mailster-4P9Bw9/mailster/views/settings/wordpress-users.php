...
<table class="form-table">
	<tr valign="top">
		...
		<td>
		<label><input type="hidden" class="wasabi" name="mailster_options[sync]" value=""><input type="checkbox" name="mailster_options[sync]" value="1" <?php checked( mailster_option( 'sync' ) ) ?> id="sync_list_check"> <?php esc_html_e( 'Sync WordPress Users with Subscribers', 'mailster' ) ?></label>
...
<table class="form-table">
	<tr valign="top">
		...
		<td>
		<label><input type="hidden" class="wasabi" name="mailster_options[delete_wp_subscriber]" value=""><input type="checkbox" name="mailster_options[delete_wp_subscriber]" value="1" <?php checked( mailster_option( 'delete_wp_subscriber' ) ) ?>> <?php esc_html_e( 'Delete Subscriber if the WordPress User gets deleted', 'mailster' ) ?></label>
		</td>
	</tr>
	<tr valign="top">
		...
		<input type="hidden" class="wasabi" name="mailster_options[delete_wp_user]" value=""><input type="checkbox" name="mailster_options[delete_wp_user]" value="1" <?php checked( mailster_option( 'delete_wp_user' ) ) ?> disabled readonly>
		<?php else : ?>
		<input type="hidden" class="wasabi" name="mailster_options[delete_wp_user]" value=""><input type="checkbox" name="mailster_options[delete_wp_user]" value="1" <?php checked( mailster_option( 'delete_wp_user' ) ) ?>>
		<?php endif; ?>
	...
	<tr valign="top">
		...
		<label><input type="hidden" class="wasabi" name="mailster_options[register_signup]" value=""><input type="checkbox" name="mailster_options[register_signup]" value="1" <?php checked( mailster_option( 'register_signup' ) ) ?> class="users-register" data-section="users-register_signup"> <?php esc_html_e( 'new WordPress users can choose to sign up on the register page', 'mailster' ) ?></label>
		<?php else : ?>
...
<div id="users-register_signup" <?php if ( ! get_option( 'users_can_register' ) || ! mailster_option( 'register_signup' ) ) { echo ' style="display:none"'; }?>>
	<table class="form-table">
		<tr valign="top">
			<th scope="row"></th>
			<td>
			<label><input type="hidden" class="wasabi" name="mailster_options[register_signup_checked]" value=""><input type="checkbox" name="mailster_options[register_signup_checked]" value="1" <?php checked( mailster_option( 'register_signup_checked' ) ) ?>> <?php esc_html_e( 'checked by default', 'mailster' ) ?></label>
			<br><label><input type="hidden" class="wasabi" name="mailster_options[register_signup_confirmation]" value=""><input type="checkbox" name="mailster_options[register_signup_confirmation]" value="1" <?php checked( mailster_option( 'register_signup_confirmation' ) ) ?>> <?php esc_html_e( 'send confirmation (double-opt-in)', 'mailster' );?></label>
...
<table class="form-table">
	<tr valign="top">
		...
		<td><label><input type="hidden" class="wasabi" name="mailster_options[register_comment_form]" value=""><input type="checkbox" name="mailster_options[register_comment_form]" value="1" <?php checked( mailster_option( 'register_comment_form' ) ) ?> class="users-register" data-section="users-register_comment_form"> <?php esc_html_e( 'Allow users to signup on the comment form if they are currently not subscribed to any list', 'mailster' );?></label>
		</td>
	</tr>
</table>
...
?>>
	<table class="form-table">
		<tr valign="top">
			<th scope="row"></th>
			<td>
			<p><label><input type="hidden" class="wasabi" name="mailster_options[register_comment_form_checked]" value=""><input type="checkbox" name="mailster_options[register_comment_form_checked]" value="1" <?php checked( mailster_option( 'register_comment_form_checked' ) ) ?>> <?php esc_html_e( 'checked by default', 'mailster' ) ?></label></p>
			<p><?php esc_html_e( 'sign up only if comment is', 'mailster' );?><br>&nbsp;&nbsp;

			<label><input type="hidden" class="wasabi" name="mailster_options[register_comment_form_status][]" value=""><input type="checkbox" name="mailster_options[register_comment_form_status][]" value="1" <?php checked( in_array( '1', mailster_option( 'register_comment_form_status', array() ) ), true ) ?>> <?php esc_html_e( 'approved', 'mailster' );?></label>
			...
			<br><label><input type="hidden" class="wasabi" name="mailster_options[register_comment_form_confirmation]" value=""><input type="checkbox" name="mailster_options[register_comment_form_confirmation]" value="1" <?php checked( mailster_option( 'register_comment_form_confirmation' ) ) ?>> <?php esc_html_e( 'send confirmation (double-opt-in)', 'mailster' );?></label>
			<p class="description"><?php esc_html_e( 'Subscribe them to these lists:', 'mailster' );?></p>
			<?php
...
<table class="form-table">
	<tr valign="top">
		...
		<td><label><input type="hidden" class="wasabi" name="mailster_options[register_other]" value=""><input type="checkbox" name="mailster_options[register_other]" value="1" <?php checked( mailster_option( 'register_other' ) ) ?> class="users-register" data-section="users-register_other"> <?php esc_html_e( 'Add people who are added via the backend or any third party plugin', 'mailster' );?></label>
		</td>
	</tr>
</table>
...
?>>
	<table class="form-table">
		<tr valign="top">
			<th scope="row"></th>
			<td>
			<p><label><input type="hidden" class="wasabi" name="mailster_options[register_other_confirmation]" value=""><input type="checkbox" name="mailster_options[register_other_confirmation]" value="1" <?php checked( mailster_option( 'register_other_confirmation' ) ) ?>> <?php esc_html_e( 'send confirmation (double-opt-in)', 'mailster' );?></label></p>
			<p class="description"><?php esc_html_e( 'Subscribe them to these lists:', 'mailster' );?></p>
			<?php
